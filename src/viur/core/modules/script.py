...
from viur.core import db, conf, current, skeleton, tasks, i18n
...
class ScriptLeafSkel(BaseScriptAbstractSkel):
    ...
    globalid = StringBone(
        ...
        params={
            "tooltip":
                "If the script was copied from an other script repository, you may want to set an "
                "unique identifier so you may match it for updates."
                }
    )
