...
class List(SkelModule):
    ...
    @exposed
    def view(self, key: db.KeyType, *args, **kwargs) -> t.Any:
        """
    ...
    def edit(self, key: db.KeyType, *, bounce: bool = False, **kwargs) -> t.Any:
        """
    ...
    @exposed
    @skey
    def delete(self, key: db.KeyType, **kwargs) -> t.Any:
        """
            Delete an entry.
    ...
    @exposed
    def index(self, key: db.KeyType = None, *args, **kwargs) -> t.Any:
        """
