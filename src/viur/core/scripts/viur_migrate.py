...
lookup = {
    ...
    "utils.downloadUrlFor": "conf.main_app.file.create_download_url",
    "utils.escapeString": "utils.string.escape",
    "utils.generateRandomString": "utils.string.random",
    "utils.getCurrentUser": "current.user.get",
    "utils.is_prefix": "utils.string.is_prefix",
    "utils.parse_bool": "utils.parse.bool",
    "utils.srcSetFor": "conf.main_app.file.create_src_set",
