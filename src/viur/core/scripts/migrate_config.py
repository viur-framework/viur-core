...
mapping = {
    ...
    "viur.debug.trace_exceptions": "debug.trace_exceptions",
    "viur.debug.trace_external_call_routing": "debug.trace_external_call_routing",
    "viur.debug.trace_internal_call_routing": "debug.trace_internal_call_routing",
    ...
    "viur.email.logRetention": "email.logRetention",
    "viur.email.recipientOverride": "email.recipientOverride",
    "viur.email.sendFromLocalDevelopmentServer": "email.sendFromLocalDevelopmentServer",
    "viur.email.senderOverride": "email.senderOverride",
    "viur.email.transportClass": "email.transportClass",
    ...
    "viur.security.enable_coep": "security.enable_coep",
    "viur.security.enable_coop": "security.enable_coop",
    "viur.security.enable_corp": "security.enable_corp",
    "viur.security.password_recovery_key_length": "security.password_recovery_key_length",
    "viur.security.permissions_policy": "security.permissions_policy",
    "viur.security.referrer_policy": "security.referrer_policy",
    "viur.security.strict_transport_security": "security.strict_transport_security",
    "viur.security.x_content_type_options": "security.x_content_type_options",
    "viur.security.x_frame_options": "security.x_frame_options",
    "viur.security.x_permitted_cross_domain_policies": "security.x_permitted_cross_domain_policies",
    "viur.security.x_xss_protection": "security.x_xss_protection",
