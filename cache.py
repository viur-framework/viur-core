...
def keyFromArgs( f, userSensitive, languageSensitive, evaluatedArgs, path, *args, **kwargs ):
	"""
		...
		@param userSensitive: Signals whereever the output of f depends on the current user.
			0 means independent of whereever the user is a guest or known, all will get the same content.
			...
			3 will cache the result of that function for each individual users seperately.
