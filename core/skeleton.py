...
class MetaSkel(MetaBaseSkel):
    def __init__(cls, name, bases, dct):
        ...
        relNewFileName = inspect.getfile(cls).replace(conf["viur.instance.core_base_path"], "").replace(
            conf["viur.instance.core_base_path"], "")
        ...
        if cls.kindName and cls.kindName is not __undefindedC__ and cls.kindName in MetaBaseSkel._skelCache:
            relOldFileName = inspect.getfile(MetaBaseSkel._skelCache[cls.kindName]) \
                .replace(conf["viur.instance.core_base_path"], "").replace(conf["viur.instance.core_base_path"], "")
            idxOld = min(
