...
__project_version = os.getenv("GAE_VERSION")
...
conf = Conf({
    ...
    "viur.instance.app_version": __project_version,
    ...
    "viur.instance.version_hash": hashlib.sha256((__project_version + __project_id).encode("UTF-8")).hexdigest()[:10],
