...
def callDeferred( func ):
	...
	def mkDefered( func, self=__undefinedFlag_, *args,  **kwargs ):
		...
		try:
			...
			req = None
		if req is not None and "HTTP_X_APPENGINE_TASKRETRYCOUNT".lower() in [x.lower() for x in os.environ] and not "DEFERED_TASK_CALLED" in dir( req ): #This is the deferred call
